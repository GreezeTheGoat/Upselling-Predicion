...
X = df.drop(columns = ["online_backup"])
y = df["online_backup"]
...
nom_features.remove("online_backup")
...
best_params = {
    "verbose": -1,
    "learning_rate": 0.038686,
    "num_leaves": 7,
    "min_child_samples": 10,
    "colsample_bytree": 0.640043,
    "n_estimators": 120,
    "random_state": 42,
    "force_row_wise": True
}
...
path_model = Path(config["paths"]["models"]).joinpath("online_backup.pkl")
