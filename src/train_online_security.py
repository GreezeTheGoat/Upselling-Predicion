...
X = df.drop(columns = ["online_security"])
y = df["online_security"]
...
nom_features.remove("online_security")
...
best_params = {
    "verbose": -1,
    "learning_rate": 0.034415,
    "num_leaves": 26,
    "min_child_samples": 10,
    "colsample_bytree": 0.563164,
    "n_estimators": 85,
    "random_state": 42,
    "force_row_wise": True
}
...
path_model = Path(config["paths"]["models"]).joinpath("online_security.pkl")
